...
| `packages/db/migrations/0122_sofa_combo_tier_offsets.sql` | Create | singleton config table |
...
**Files:**
- Create: `packages/db/migrations/0122_sofa_combo_tier_offsets.sql`
- Modify: `packages/db/src/schema.ts`

- [ ] **Step 1: Create the migration** — `packages/db/migrations/0122_sofa_combo_tier_offsets.sql`:
...
```bash
git add packages/db/migrations/0122_sofa_combo_tier_offsets.sql packages/db/src/schema.ts
git commit -m "feat(sofa): sofa_combo_tier_offsets singleton config table (migration 0122)"
```
...
- [ ] **Step 2: Apply migration `0122` to PROD — REQUIRES explicit Chairman "go"**
