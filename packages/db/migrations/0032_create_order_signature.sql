-- 0032_create_order_signature.sql
-- Extend create_order_with_items to persist the customer's e-signature
-- (added by migration 0031 as orders.signature_data). Body of the function
-- is otherwise unchanged from 0028 — only the INSERT picks up one more
-- column + value pair.
