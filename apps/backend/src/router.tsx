...
// Office-wide announcements (migration 0210). Banner + composer page.
const Announcements = lazyRetry(() => import('./pages/Announcements').then(m => ({ default: m.Announcements })));
...
export const router = createBrowserRouter([
  ...
  { path: '/sso', element: <Sso /> },
  {
    ...
    children: [
      ...
      // Office-wide announcements (mig 0210). Composer + posted list +
      // read-receipts; banner mounts inside Layout.
