 ...
 * preferring the smaller `thumb_key` over the hero `img_key`. Falls back to
 * the product's initial on the warm placeholder while the catalog loads or
 * when a product has no photo — matching CustomerOrderSheet's treatment.
 *
