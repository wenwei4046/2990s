...
export const FabricsTable = ({
  ...
  showHeader?: boolean;
  /** POS view: hide write affordances + lock all cell editors. The list
   *  remains scrollable and the tier chips still render so commander can
   *  see the current tier — but clicks are inert. */
  readonly?: boolean;
}) => (
  <>
    {error && !isLoading && (
